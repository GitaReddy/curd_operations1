<script>
  ...
  let language = [];
    ...
    async function fetchData()  {
      ...
      const userDataResponse = await fetch("https://api.recruitly.io/api/me/profile?apiKey=TEST1236C4CF23E6921C41429A6E1D546AC9535E");
...
,
    ...
    async function updateData() {
      ...
      try {
        const response = await fetch("https://api.recruitly.io/api/me/save?apiKey=TEST1236C4CF23E6921C41429A6E1D546AC9535E",
        {
          method: "POST",
          headers: {
    ...
    async function fetchTimeZone() {
        ...
        "https://api.recruitly.io/api/lookup/timezone?apiKey=TEST1236C4CF23E6921C41429A6E1D546AC9535E"
    )
    ...
    try {
      const response = await fetch(
        "https://api.recruitly.io/api/lookup/languages?apiKey=TEST1236C4CF23E6921C41429A6E1D546AC9535E"
      );
      const responseData = await response.json();
  ...
  function handleSelection(event) {
    ...
    const uploadImage = () => {
        ...
        fetch(
            "https://api.recruitly.io/api/image/upload?apiKey=TEST1236C4CF23E6921C41429A6E1D546AC9535E",
            {
                method: "POST",
                body: formData,
            }
    ...
    const fetchCountryData = async () => {
        try {
            const response = await fetch(
                "https://api.recruitly.io/api/lookup/countries?apiKey=" +
