<script>
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(
                "https://api.recruitly.io/api/business/profile?apiKey=" +
    ...
    async function fetchTimeZone() {
        try {
            const response = await fetch(
                "https://api.recruitly.io/api/lookup/timezone?apiKey=" +
                    appData.service.apiKey
            );
    ...
    async function fetchCurrency() {
        try {
            const response = await fetch(
                "https://api.recruitly.io/api/lookup/currency?apiKey=" +
                    appData.service.apiKey
            );
            const responseData = await response.json();
    ...
    export async function updateData() {
        ...
        fetch(
            "https://api.recruitly.io/api/business/profile/save?apiKey=" +
                appData.service.apiKey,
            {
                method: "POST",
                headers: {
